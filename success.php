  ...
  <meta http-equiv="refresh" content="0.2; url='tg://join?invite=GjiPeQ3Dq8A4Mjc0'" />
 <script>
    ...
    <img src="img/LogoBig_1x.png" alt="">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <!-- Заголовок канала -->
          <h1 class="jumbotron-heading">Crypto Moon</h1>
          <!-- Описание, укажите здесь то, что замотивирует человека подписаться -->
          <p style="display:block" class="lead text-muted">Your best guide in world of trading and crypto
We will help you earn on bull and bear market.</p>
          <p>
